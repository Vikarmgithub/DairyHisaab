...
public class BackupFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        // 💡 यहाँ से WhatsApp बटन का क्लिक लिसनर हटा दिया गया है
    ...
    private void doFirebaseRestore() {
        ...
        pd.setCancelable(false);
        pd.show();
        firebaseManager.downloadAllData(new FirebaseManager.DownloadCallback() {
            @Override
            public void onSuccess(java.util.Map<String, Object> data) {
                requireActivity().runOnUiThread(() -> {
                    ...
                    new AlertDialog.Builder(requireContext())
                            ...
                            .setMessage("Cloud se restore karne se SAARA CURRENT DATA replace ho jayega.\n\nSure hain?")
